...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bFscrollWidget.setGeometry(QtCore.QRect(0, 0, 377, 88))
        ...
        self.eRscrollWidget.setGeometry(QtCore.QRect(0, 0, 377, 121))
        ...
        self.tScrollWidget.setGeometry(QtCore.QRect(0, 0, 393, 88))
        ...
        self.glmCalc.setMaximumSize(QtCore.QSize(180, 16777215))
        ...
        self.cScrollWidget.setGeometry(QtCore.QRect(0, 0, 460, 111))
        ...
        self.GLMGroupBox.setMinimumSize(QtCore.QSize(360, 300))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.GLMScrollArea.setMinimumSize(QtCore.QSize(0, 300))
        ...
        self.GLMScrollWidget.setGeometry(QtCore.QRect(0, 0, 393, 298))
        ...
        self.exportpwrcsv.setMaximumSize(QtCore.QSize(190, 16777215))
        ...
        self.resetglm = QtWidgets.QPushButton(self.GLMGroupBox)
        self.resetglm.setMaximumSize(QtCore.QSize(190, 16777215))
        self.resetglm.setObjectName("resetglm")
        self.horizontalLayout_10.addWidget(self.resetglm)
        ...
        self.PCGroupBox.setMinimumSize(QtCore.QSize(360, 250))
        font = QtGui.QFont()
        font.setPointSize(13)
        ...
        self.PCScrollWidget.setGeometry(QtCore.QRect(0, 0, 393, 223))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.GLMGroupBox.setTitle(_translate("MainWindow", "General Linear Model - Pairwise t-test Output:"))
        self.parsepower.setText(_translate("MainWindow", "Parse and estimate power"))
        self.exportpwrcsv.setText(_translate("MainWindow", "Export results to CSV"))
        self.resetglm.setText(_translate("MainWindow", "Reset and run again"))
